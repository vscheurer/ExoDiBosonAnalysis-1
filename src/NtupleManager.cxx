...
void NtupleManager::ConnectVariables( std::string treeName  ){
  ...
  theAnalysis_->ConnectVariable( treeName.c_str(), "lep_isLooseElectron"  , theData_.lep_isLooseElectron); 
  theAnalysis_->ConnectVariable( treeName.c_str(), "lep_isMediumElectron" , theData_.lep_isMediumElectron); 
  theAnalysis_->ConnectVariable( treeName.c_str(), "lep_isTightElectron"  , theData_.lep_isTightElectron); 
  theAnalysis_->ConnectVariable( treeName.c_str(), "lep_isHeepElectron"   , theData_.lep_isHeepElectron); 
  ...
  // theAnalysis_->ConnectVariable( treeName.c_str(), "ngenJetsAK8"    , theData_.ngenJetsAK8    );
  ...
  theAnalysis_->ConnectVariable( treeName.c_str(), "nsoftdropsubjets"         , theData_.nsoftdropsubjets         );
  theAnalysis_->ConnectVariable( treeName.c_str(), "subjetAK8softdrop_csv"  	, theData_.subjetAK8softdrop_csv    );  
  theAnalysis_->ConnectVariable( treeName.c_str(), "subjetAK8softdrop_pt"   	, theData_.subjetAK8softdrop_pt     );  
  theAnalysis_->ConnectVariable( treeName.c_str(), "subjetAK8softdrop_eta"  	, theData_.subjetAK8softdrop_eta    );  
  theAnalysis_->ConnectVariable( treeName.c_str(), "subjetAK8softdrop_phi"  	, theData_.subjetAK8softdrop_phi    );  
  theAnalysis_->ConnectVariable( treeName.c_str(), "subjetAK8softdrop_e"    	, theData_.subjetAK8softdrop_e      );  
  theAnalysis_->ConnectVariable( treeName.c_str(), "subjetAK8softdrop_flavour", theData_.subjetAK8softdrop_flavor	);  
  ...
  //   theAnalysis_->ConnectVariable( treeName.c_str(), "isFired_HLT_PFHT350_v1"                   , theData_.isFired_HLT_PFHT350_v1                    );
  //   theAnalysis_->ConnectVariable( treeName.c_str(), "isFired_HLT_PFHT600_v1"                   , theData_.isFired_HLT_PFHT600_v1                    );
  //   theAnalysis_->ConnectVariable( treeName.c_str(), "isFired_HLT_PFHT650_v1"                   , theData_.isFired_HLT_PFHT650_v1                    );
  //   theAnalysis_->ConnectVariable( treeName.c_str(), "isFired_HLT_PFHT900_v1"                   , theData_.isFired_HLT_PFHT900_v1                    );
  // theAnalysis_->ConnectVariable( treeName.c_str(), "isFired_HLT_HT400_v1"                     , theData_.isFired_HLT_HT400_v1                      );
