...
if mass != 'QCD':
    ...
    #file = TFile.Open("/portal/ekpbms2/home/vscheurer/AnalysisOutput/Data4.root")
    ...
    OutputFilename = "../DijetCombineLimitCode/MCPlotsdata09.root"
    OutputFile = TFile(OutputFilename, "RECREATE")
    #print "bb:     " , BtaggedMass.GetEntries()
    print "ZZHP:   " , ZZHP.GetEntries()
    print "WWHP:   " , WWHP.GetEntries()
    ...
    print "WZLP:   " , WZLP.GetEntries()
    print "ZZHPBtagged:   " , ZZHPBtagged.GetEntries()
    print "WWHPBtagged:   " , WWHPBtagged.GetEntries()
    print "WZHPBtagged:   " , WZHPBtagged.GetEntries()
    print "ZZLPBtagged:   " , ZZLPBtagged.GetEntries()
    print "WWLPBtagged:   " , WWLPBtagged.GetEntries()
    print "WZLPBtagged:   " , WZLPBtagged.GetEntries()
