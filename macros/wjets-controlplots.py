...
fillColor = [1,2,210,4,ROOT.TColor.kCyan,ROOT.TColor.kAzure+8,ROOT.TColor.kPink-7]
...
for h in histos:
   ...
   l = ROOT.TLegend(0.68,0.59,0.89,0.86,"","NDC")
   l.SetLineWidth(2)
   l.SetBorderSize(0)
   l.SetFillColor(0)
   l.SetTextFont(42)
   ...
   pad0 = ROOT.TPad("pad0","pad0",0.,0.,0.99,1.)
   ...
   if data == "":
      hs.SetMaximum(histolist[0].GetMaximum()+100)     
   if signal != "":
...
if data != "":
   ...
   h = ROOT.TH1F(file_data.Get("AK8bjetPrunedMass"))
...
if signal != "":
   ...
   h = ROOT.TH1F(file_signal.Get("AK8bjetPrunedMass"))
   tmp = []
...
for f in range(0,len(filelist)):
   ...
   h = ROOT.TH1F(filelist[f].Get("AK8bjetPrunedMass"))
